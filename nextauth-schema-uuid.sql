-- NextAuth.js required tables for PostgreSQL (UUID version)
-- Run this SQL in your PostgreSQL database to add NextAuth.js support

-- Accounts table (for OAuth providers) - using UUID for user_id
...
-- Sessions table (for session management) - using UUID for user_id
